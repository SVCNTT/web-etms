<div class="modal-confirm ">
    <div class="modal-info">
        <div class="header">
            <span class="title" class="pull-left"> <?php echo SAL0110_LABEL_TITLE; ?>
            </span> <span class="pull-right close icon-close"
                ng-click="closeImportMrs()"></span>
        </div>

            <div class="body">
                <span><?php echo SAL0110_LABEL_CHOOSE_FILE; ?>:</span>
            ...
            <div class="footer">
                <button type="button" ng-click="upload()" ng-disabled="files.length==0 || files ==null"
                    ...
                    <?php echo SAL0110_BUTTON_UPLOAD_PRICE; ?>
                </button>
            </div>
    </div>
</div>
