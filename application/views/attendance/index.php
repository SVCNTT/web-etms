                        ...
                        <div class="table-region">
                            ...
                            <table
                                ...
                                <tr ng-class="{'active': $index == model.hidden.activeRow}"
                                    ng-repeat="salemanItem in model.form.DAS0140SearchResult.salesmanAttendance ">
