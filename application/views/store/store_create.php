							...
							<div class="form-create create-store">
								<div class="group">
									<div class="storename">
                                        ...
                                        class="required"><?php echo COMMON_REQUIRED; ?></span></span> :<input ng-class="{'validate': model.hidden.validated.storeName.isErrored == true}"
											ng-model="model.form.STO0200CreateStoreInputModel.storeName"
