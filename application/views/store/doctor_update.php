						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h3 class="panel-title">
									...
									<?php echo STO0210_LABEL_FORM_DOCTOR; ?>
								</h3>
							</div>
									...
									<div class="group">
										...
										<div class="docname">
                                            ...
                                            class="required"><?php echo COMMON_REQUIRED; ?></span></span> :<input id="storeId"
												...
												ng-model="model.hidden.storeId"> <input ng-class="{'validate': model.hidden.validated.docName.isErrored == true}"
												ng-model="model.form.STO0210SelectStoreResultDto.selectSore.docName"
												type="text" class="form-control-dms"
												value="{{model.form.STO0210SelectStoreResultDto.selectSore.docName}}">
										</div>
										<div class="title">
											<span><?php echo STO0200_LABEL_DOCTOR_TITLE; ?></span> : 
												<input ng-model="model.form.STO0210SelectStoreResultDto.selectSore.title"
												type="text" class="form-control-dms"
												value="{{model.form.STO0210SelectStoreResultDto.selectSore.title}}">
										</div>									
										<div class="leval">
											<span><?php echo STO0200_LABEL_DOCTOR_POSITION; ?></span> : 
												<input ng-model="model.form.STO0210SelectStoreResultDto.selectSore.position"
												type="text" class="form-control-dms"
												value="{{model.form.STO0210SelectStoreResultDto.selectSore.position}}">
										</div>
										<div class="specialty">
											<span><?php echo STO0200_LABEL_DOCTOR_SPECIALTY; ?></span> : 
												<input ng-model="model.form.STO0210SelectStoreResultDto.selectSore.specialty"
												type="text" class="form-control-dms"
												value="{{model.form.STO0210SelectStoreResultDto.selectSore.specialty}}">
										</div>
										<div class="department">
											<span><?php echo STO0200_LABEL_DOCTOR_DEPARTMENT; ?></span> : 
												<input ng-model="model.form.STO0210SelectStoreResultDto.selectSore.department"
												type="text" class="form-control-dms"
												value="{{model.form.STO0210SelectStoreResultDto.selectSore.department}}">
										</div>
										<div class="class">
										...
										<div class="hospital">
											<span><?php echo STO0200_LABEL_DOCTOR_HOSPITAL; ?></span> : 
												<input ng-model="model.form.STO0210SelectStoreResultDto.selectSore.hospital"
												type="text" class="form-control-dms"
												value="{{model.form.STO0210SelectStoreResultDto.selectSore.hospital}}">
										</div>	
										<div class="zone">
										...
										<!-- <div class="mr">
											<span><?php echo STO0200_LABEL_DOCTOR_MR; ?></span> : 
												<input ng-model="model.form.STO0210SelectStoreResultDto.selectSore.mr"
												type="text" class="form-control-dms"
												value="{{model.form.STO0210SelectStoreResultDto.selectSore.mr}}">
										</div>	 -->	
										<div class="bu">
