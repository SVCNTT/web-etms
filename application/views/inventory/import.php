<div class="modal-confirm ">
    <div class="modal-info">
        <div class="header">
            <span class="title" class="pull-left"> <?php echo STO0610_LABEL_TITLE; ?>
            </span> <span class="pull-right close icon-close"
                          ng-click="closeImportInventory()"></span>
        </div>

        <div class="body">
            <span><?php echo STO0610_LABEL_CHOOSE_FILE; ?>:</span>
