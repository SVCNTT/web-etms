(function(d){"function"==typeof define&&define.amd?define(["jquery"],d):d(jQuery)})(function(d){function T(a,b){var c,e,f,g=a.nodeName.toLowerCase();return"area"===g?(c=a.parentNode,e=c.name,a.href&&e&&"map"===c.nodeName.toLowerCase()?(f=d("img[usemap=#"+e+"]")[0],!!f&&U(f)):!1):(/input|select|textarea|button|object/.test(g)?!a.disabled:"a"===g?a.href||b:b)&&U(a)}function U(a){return d.expr.filters.visible(a)&&!d(a).parents().addBack().filter(function(){return"hidden"===d.css(this,"visibility")}).length}
    function Z(a){for(var b,c;a.length&&a[0]!==document;){if(b=a.css("position"),("absolute"===b||"relative"===b||"fixed"===b)&&(c=parseInt(a.css("zIndex"),10),!isNaN(c)&&0!==c))return c;a=a.parent()}return 0}function V(){this._curInst=null;this._keyEvent=!1;this._disabledInputs=[];this._inDialog=this._datepickerShowing=!1;this._mainDivId="ui-datepicker-div";this._inlineClass="ui-datepicker-inline";this._appendClass="ui-datepicker-append";this._triggerClass="ui-datepicker-trigger";this._dialogClass="ui-datepicker-dialog";
        ...
        "mouseover",function(){d.datepicker._isDisabledDatepicker(R.inline?a.parent()[0]:R.input[0])||(d(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),d(this).addClass("ui-state-hover"),-1!==this.className.indexOf("ui-datepicker-prev")&&d(this).addClass("ui-datepicker-prev-hover"),-1!==this.className.indexOf("ui-datepicker-next")&&d(this).addClass("ui-datepicker-next-hover"))})}function K(a,b){d.extend(a,b);for(var c in b)null==b[c]&&(a[c]=b[c]);return a}function D(a){return function(){var b=
    ...
    (d.fn.removeData=function(a){return function(b){return arguments.length?a.call(this,d.camelCase(b)):a.call(this)}}(d.fn.removeData));d.ui.ie=!!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase());d.fn.extend({focus:function(a){return function(b,c){return"number"==typeof b?this.each(function(){var a=this;setTimeout(function(){d(a).focus();c&&c.call(a)},b)}):a.apply(this,arguments)}}(d.fn.focus),disableSelection:function(){var a="onselectstart"in document.createElement("div")?"selectstart":"mousedown";
        ...
        for(e in c)a.plugins[e]=a.plugins[e]||[],a.plugins[e].push([b,c[e]])},call:function(a,b,c,d){if((b=a.plugins[b])&&(d||a.element[0].parentNode&&11!==a.element[0].parentNode.nodeType))for(d=0;b.length>d;d++)a.options[b[d][0]]&&b[d][1].apply(a.element,c)}};var aa=0,X=Array.prototype.slice;d.cleanData=function(a){return function(b){for(var c,e=0;null!=(c=b[e]);e++)try{d(c).triggerHandler("remove")}catch(f){}a(b)}}(d.cleanData);d.widget=function(a,b,c){var e,f,g,h,l={},k=a.split(".")[0];return a=a.split(".")[1],
        e=k+"-"+a,c||(c=b,b=d.Widget),d.expr[":"][e.toLowerCase()]=function(a){return!!d.data(a,e)},d[k]=d[k]||{},f=d[k][a],g=d[k][a]=function(a,b){return this._createWidget?(arguments.length&&this._createWidget(a,b),void 0):new g(a,b)},d.extend(g,f,{version:c.version,_proto:d.extend({},c),_childConstructors:[]}),h=new b,h.options=d.widget.extend({},h.options),d.each(c,function(a,c){return d.isFunction(c)?(l[a]=function(){var d=function(){return b.prototype[a].apply(this,arguments)},e=function(c){return b.prototype[a].apply(this,
        c)};return function(){var a,b=this._super,f=this._superApply;return this._super=d,this._superApply=e,a=c.apply(this,arguments),this._super=b,this._superApply=f,a}}(),void 0):(l[a]=c,void 0)}),g.prototype=d.widget.extend(h,{widgetEventPrefix:f?h.widgetEventPrefix||a:a},l,{constructor:g,namespace:k,widgetName:a,widgetFullName:e}),f?(d.each(f._childConstructors,function(a,b){var c=b.prototype;d.widget(c.namespace+"."+c.widgetName,g,b._proto)}),delete f._childConstructors):b._childConstructors.push(g),
        d.widget.bridge(a,g),g};d.widget.extend=function(a){for(var b,c,e=X.call(arguments,1),f=0,g=e.length;g>f;f++)for(b in e[f])c=e[f][b],e[f].hasOwnProperty(b)&&void 0!==c&&(a[b]=d.isPlainObject(c)?d.isPlainObject(a[b])?d.widget.extend({},a[b],c):d.widget.extend({},c):c);return a};d.widget.bridge=function(a,b){var c=b.prototype.widgetFullName||a;d.fn[a]=function(e){var f="string"==typeof e,g=X.call(arguments,1),h=this;return e=!f&&g.length?d.widget.extend.apply(null,[e].concat(g)):e,f?this.each(function(){var b,
    ...
    e[a]?null:e[a];e[a]=b}else{if(1===arguments.length)return void 0===this.options[a]?null:this.options[a];g[a]=b}return this._setOptions(g),this},_setOptions:function(a){for(var b in a)this._setOption(b,a[b]);return this},_setOption:function(a,b){return this.options[a]=b,"disabled"===a&&(this.widget().toggleClass(this.widgetFullName+"-disabled",!!b),b&&(this.hoverable.removeClass("ui-state-hover"),this.focusable.removeClass("ui-state-focus"))),this},enable:function(){return this._setOptions({disabled:!1})},
        disable:function(){return this._setOptions({disabled:!0})},_on:function(a,b,c){var e,f=this;"boolean"!=typeof a&&(c=b,b=a,a=!1);c?(b=e=d(b),this.bindings=this.bindings.add(b)):(c=b,b=this.element,e=this.widget());d.each(c,function(c,h){function l(){return a||!0!==f.options.disabled&&!d(this).hasClass("ui-state-disabled")?("string"==typeof h?f[h]:h).apply(f,arguments):void 0}"string"!=typeof h&&(l.guid=h.guid=h.guid||l.guid||d.guid++);var k=c.match(/^([\w:-]*)\s*(.*)$/),m=k[1]+f.eventNamespace;(k=
            k[2])?e.delegate(k,m,l):b.bind(m,l)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(b).undelegate(b)},_delay:function(a,b){var c=this;return setTimeout(function(){return("string"==typeof a?c[a]:a).apply(c,arguments)},b||0)},_hoverable:function(a){this.hoverable=this.hoverable.add(a);this._on(a,{mouseenter:function(a){d(a.currentTarget).addClass("ui-state-hover")},mouseleave:function(a){d(a.currentTarget).removeClass("ui-state-hover")}})},_focusable:function(a){this.focusable=
    ...
    d.each({show:"fadeIn",hide:"fadeOut"},function(a,b){d.Widget.prototype["_"+a]=function(c,e,f){"string"==typeof e&&(e={effect:e});var g,h=e?!0===e||"number"==typeof e?b:e.effect||b:a;e=e||{};"number"==typeof e&&(e={duration:e});g=!d.isEmptyObject(e);e.complete=f;e.delay&&c.delay(e.delay);g&&d.effects&&d.effects.effect[h]?c[a](e):h!==a&&c[h]?c[h](e.duration,e.easing,f):c.queue(function(b){d(this)[a]();f&&f.call(c[0]);b()})}});d.widget;var P=!1;d(document).mouseup(function(){P=!1});d.widget("ui.mouse",
        ...
        offset:a.offset()}}d.ui=d.ui||{};var c,e,f=Math.max,g=Math.abs,h=Math.round,l=/left|center|right/,k=/top|center|bottom/,m=/[\+\-]\d+(\.[\d]+)?%?/,n=/^\w+/,p=/%$/,r=d.fn.position;d.position={scrollbarWidth:function(){if(void 0!==c)return c;var a,b,e=d("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),f=e.children()[0];return d("body").append(e),a=f.offsetWidth,e.css("overflow","scroll"),b=f.offsetWidth,a===b&&
    ...
    9===a[0].nodeType,offset:a.offset()||{left:0,top:0},scrollLeft:a.scrollLeft(),scrollTop:a.scrollTop(),width:b?a.width():a.outerWidth(),height:b?a.height():a.outerHeight()}}};d.fn.position=function(c){if(!c||!c.of)return r.apply(this,arguments);c=d.extend({},c);var q,t,v,A,p,B,w=d(c.of),E=d.position.getWithinInfo(c.within),y=d.position.getScrollInfo(E),J=(c.collision||"flip").split(" "),L={};return B=b(w),w[0].preventDefault&&(c.at="left top"),t=B.width,v=B.height,A=B.offset,p=d.extend({},A),d.each(["my",
        "at"],function(){var a,b,d=(c[this]||"").split(" ");1===d.length&&(d=l.test(d[0])?d.concat(["center"]):k.test(d[0])?["center"].concat(d):["center","center"]);d[0]=l.test(d[0])?d[0]:"center";d[1]=k.test(d[1])?d[1]:"center";a=m.exec(d[0]);b=m.exec(d[1]);L[this]=[a?a[0]:0,b?b[0]:0];c[this]=[n.exec(d[0])[0],n.exec(d[1])[0]]}),1===J.length&&(J[1]=J[0]),"right"===c.at[0]?p.left+=t:"center"===c.at[0]&&(p.left+=t/2),"bottom"===c.at[1]?p.top+=v:"center"===c.at[1]&&(p.top+=v/2),q=a(L.at,t,v),p.left+=q[0],p.top+=
        q[1],this.each(function(){var b,k,l=d(this),m=l.outerWidth(),n=l.outerHeight(),r=parseInt(d.css(this,"marginLeft"),10)||0,B=parseInt(d.css(this,"marginTop"),10)||0,D=m+r+(parseInt(d.css(this,"marginRight"),10)||0)+y.width,O=n+B+(parseInt(d.css(this,"marginBottom"),10)||0)+y.height,x=d.extend({},p),G=a(L.my,l.outerWidth(),l.outerHeight());"right"===c.my[0]?x.left-=m:"center"===c.my[0]&&(x.left-=m/2);"bottom"===c.my[1]?x.top-=n:"center"===c.my[1]&&(x.top-=n/2);x.left+=G[0];x.top+=G[1];e||(x.left=h(x.left),
        x.top=h(x.top));b={marginLeft:r,marginTop:B};d.each(["left","top"],function(a,e){d.ui.position[J[a]]&&d.ui.position[J[a]][e](x,{targetWidth:t,targetHeight:v,elemWidth:m,elemHeight:n,collisionPosition:b,collisionWidth:D,collisionHeight:O,offset:[q[0]+G[0],q[1]+G[1]],my:c.my,at:c.at,within:E,elem:l})});c.using&&(k=function(a){var b=A.left-x.left,d=b+t-m,e=A.top-x.top,h=e+v-n,k={target:{element:w,left:A.left,top:A.top,width:t,height:v},element:{element:l,left:x.left,top:x.top,width:m,height:n},horizontal:0>
    d?"left":0<b?"right":"center",vertical:0>h?"top":0<e?"bottom":"middle"};m>t&&t>g(b+d)&&(k.horizontal="center");n>v&&v>g(e+h)&&(k.vertical="middle");k.important=f(g(b),g(d))>f(g(e),g(h))?"horizontal":"vertical";c.using.call(this,a,k)});l.offset(d.extend(x,{using:k}))})};d.ui.position={fit:{left:function(a,b){var c,d=b.within,e=d.isWindow?d.scrollLeft:d.offset.left,d=d.width,g=a.left-b.collisionPosition.marginLeft,h=e-g,k=g+b.collisionWidth-d-e;b.collisionWidth>d?0<h&&0>=k?(c=a.left+h+b.collisionWidth-
    d-e,a.left+=h-c):a.left=0<k&&0>=h?e:h>k?e+d-b.collisionWidth:e:0<h?a.left+=h:0<k?a.left-=k:a.left=f(a.left-g,a.left)},top:function(a,b){var c,d=b.within,d=d.isWindow?d.scrollTop:d.offset.top,e=b.within.height,g=a.top-b.collisionPosition.marginTop,h=d-g,k=g+b.collisionHeight-e-d;b.collisionHeight>e?0<h&&0>=k?(c=a.top+h+b.collisionHeight-e-d,a.top+=h-c):a.top=0<k&&0>=h?d:h>k?d+e-b.collisionHeight:d:0<h?a.top+=h:0<k?a.top-=k:a.top=f(a.top-g,a.top)}},flip:{left:function(a,b){var c,d,e=b.within,f=e.offset.left+
        e.scrollLeft,h=e.width,e=e.isWindow?e.scrollLeft:e.offset.left,k=a.left-b.collisionPosition.marginLeft,l=k-e,k=k+b.collisionWidth-h-e,m="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,n="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,p=-2*b.offset[0];0>l?(c=a.left+m+n+p+b.collisionWidth-h-f,(0>c||g(l)>c)&&(a.left+=m+n+p)):0<k&&(d=a.left-b.collisionPosition.marginLeft+m+n+p-e,(0<d||k>g(d))&&(a.left+=m+n+p))},top:function(a,b){var c,d,e=b.within,f=e.offset.top+e.scrollTop,
        h=e.height,e=e.isWindow?e.scrollTop:e.offset.top,k=a.top-b.collisionPosition.marginTop,l=k-e,k=k+b.collisionHeight-h-e,m="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,n="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,p=-2*b.offset[1];0>l?(d=a.top+m+n+p+b.collisionHeight-h-f,a.top+m+n+p>l&&(0>d||g(l)>d)&&(a.top+=m+n+p)):0<k&&(c=a.top-b.collisionPosition.marginTop+m+n+p-e,a.top+m+n+p>k&&(0<c||k>g(c))&&(a.top+=m+n+p))}},flipfit:{left:function(){d.ui.position.flip.left.apply(this,
    ...
    d.ui.keyCode.UP&&a.ctrlKey&&d(a.currentTarget).prev().focus()},refresh:function(){var a=this.options;this._processPanels();!1===a.active&&!0===a.collapsible||!this.headers.length?(a.active=!1,this.active=d()):!1===a.active?this._activate(0):this.active.length&&!d.contains(this.element[0],this.active[0])?this.headers.length===this.headers.find(".ui-state-disabled").length?(a.active=!1,this.active=d()):this._activate(Math.max(0,a.active-1)):a.active=this.headers.index(this.active);this._destroyIcons();
        ...
        b);this._on(this.headers.next(),{keydown:"_panelKeyDown"});this._hoverable(this.headers);this._focusable(this.headers)},_eventHandler:function(a){var b=this.options,c=this.active,e=d(a.currentTarget),f=e[0]===c[0],g=f&&b.collapsible,h=g?d():e.next(),l=c.next(),h={oldHeader:c,oldPanel:l,newHeader:g?d():e,newPanel:h};a.preventDefault();f&&!b.collapsible||!1===this._trigger("beforeActivate",a,h)||(b.active=g?!1:this.headers.index(e),this.active=f?d():e,this._toggle(h),c.removeClass("ui-accordion-header-active ui-state-active"),
    b.icons&&c.children(".ui-accordion-header-icon").removeClass(b.icons.activeHeader).addClass(b.icons.header),f||(e.removeClass("ui-corner-all").addClass("ui-accordion-header-active ui-state-active ui-corner-top"),b.icons&&e.children(".ui-accordion-header-icon").removeClass(b.icons.header).addClass(b.icons.activeHeader),e.next().addClass("ui-accordion-content-active")))},_toggle:function(a){var b=a.newPanel,c=this.prevShow.length?this.prevShow:a.oldPanel;this.prevShow.add(this.prevHide).stop(!0,!0);
        this.prevShow=b;this.prevHide=c;this.options.animate?this._animate(b,c,a):(c.hide(),b.show(),this._toggleComplete(a));c.attr({"aria-hidden":"true"});c.prev().attr("aria-selected","false");b.length&&c.length?c.prev().attr({tabIndex:-1,"aria-expanded":"false"}):b.length&&this.headers.filter(function(){return 0===d(this).attr("tabIndex")}).attr("tabIndex",-1);b.attr("aria-hidden","false").prev().attr({"aria-selected":"true",tabIndex:0,"aria-expanded":"true"})},_animate:function(a,b,c){var d,f,g,h=this,
        l=0,k=a.length&&(!b.length||a.index()<b.index()),m=this.options.animate||{},k=k&&m.down||m,n=function(){h._toggleComplete(c)};return"number"==typeof k&&(g=k),"string"==typeof k&&(f=k),f=f||k.easing||m.easing,g=g||k.duration||m.duration,b.length?a.length?(d=a.show().outerHeight(),b.animate(this.hideProps,{duration:g,easing:f,step:function(a,b){b.now=Math.round(a)}}),a.hide().animate(this.showProps,{duration:g,easing:f,complete:n,step:function(a,c){c.now=Math.round(a);"height"!==c.prop?l+=c.now:"content"!==
    h.options.heightStyle&&(c.now=Math.round(d-b.outerHeight()-l),l=0)}}),void 0):b.animate(this.hideProps,g,f,n):a.animate(this.showProps,g,f,n)},_toggleComplete:function(a){var b=a.oldPanel;b.removeClass("ui-accordion-content-active").prev().removeClass("ui-corner-top").addClass("ui-corner-all");b.length&&(b.parent()[0].className=b.parent()[0].className);this._trigger("activate",null,a)}});d.widget("ui.menu",{version:"1.11.0",defaultElement:"<ul>",delay:300,options:{icons:{submenu:"ui-icon-carat-1-e"},
    ...
    a&&/^mouse/.test(a.type)&&this._startOpening(c);this.activeMenu=b.parent();this._trigger("focus",a,{item:b})},_scrollIntoView:function(a){var b,c,e,f,g,h;this._hasScroll()&&(b=parseFloat(d.css(this.activeMenu[0],"borderTopWidth"))||0,c=parseFloat(d.css(this.activeMenu[0],"paddingTop"))||0,e=a.offset().top-this.activeMenu.offset().top-b-c,f=this.activeMenu.scrollTop(),g=this.activeMenu.height(),h=a.outerHeight(),0>e?this.activeMenu.scrollTop(f+e):e+h>g&&this.activeMenu.scrollTop(f+e-g+h))},blur:function(a,
        ...
        (a.preventDefault(),a.stopImmediatePropagation())});this._on({focus:function(){this.buttonElement.addClass("ui-state-focus")},blur:function(){this.buttonElement.removeClass("ui-state-focus")}});c&&this.element.bind("change"+this.eventNamespace,function(){a.refresh()});"checkbox"===this.type?this.buttonElement.bind("click"+this.eventNamespace,function(){return b.disabled?!1:void 0}):"radio"===this.type?this.buttonElement.bind("click"+this.eventNamespace,function(){if(b.disabled)return!1;d(this).addClass("ui-state-active");
            a.buttonElement.attr("aria-pressed","true");var c=a.element[0];Y(c).not(c).map(function(){return d(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")}):(this.buttonElement.bind("mousedown"+this.eventNamespace,function(){return b.disabled?!1:(d(this).addClass("ui-state-active"),S=this,a.document.one("mouseup",function(){S=null}),void 0)}).bind("mouseup"+this.eventNamespace,function(){return b.disabled?!1:(d(this).removeClass("ui-state-active"),void 0)}).bind("keydown"+
        ...
        _create:function(){this.element.addClass("ui-buttonset")},_init:function(){this.refresh()},_setOption:function(a,b){"disabled"===a&&this.buttons.button("option",a,b);this._super(a,b)},refresh:function(){var a="rtl"===this.element.css("direction"),b=this.element.find(this.options.items),c=b.filter(":ui-button");b.not(":ui-button").button();c.button("refresh");this.buttons=b.map(function(){return d(this).button("widget")[0]}).removeClass("ui-corner-all ui-corner-left ui-corner-right").filter(":first").addClass(a?
            "ui-corner-right":"ui-corner-left").end().filter(":last").addClass(a?"ui-corner-left":"ui-corner-right").end().end()},_destroy:function(){this.element.removeClass("ui-buttonset");this.buttons.map(function(){return d(this).button("widget")[0]}).removeClass("ui-corner-left ui-corner-right").end().button("destroy")}});d.ui.button;d.extend(d.ui,{datepicker:{version:"1.11.0"}});var R;d.extend(V.prototype,{markerClassName:"hasDatepicker",maxRows:4,_widgetDatepicker:function(){return this.dpDiv},setDefaults:function(a){return K(this._defaults,
    ...
    b.settings.disabled&&this._disableDatepicker(a),b.dpDiv.css("display","block"))},_dialogDatepicker:function(a,b,c,e,f){var g,h,l,k,m;a=this._dialogInst;return a||(this.uuid+=1,g="dp"+this.uuid,this._dialogInput=d("<input type='text' id='"+g+"' style='position: absolute; top: -100px; width: 0px;'/>"),this._dialogInput.keydown(this._doKeyDown),d("body").append(this._dialogInput),a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a)),K(a.settings,
    ...
    typeof b?"defaults"===b?d.extend({},d.datepicker._defaults):l?"all"===b?d.extend({},l.settings):this._get(l,b):null:(e=b||{},"string"==typeof b&&(e={},e[b]=c),l&&(this._curInst===l&&this._hideDatepicker(),f=this._getDateDatepicker(a,!0),g=this._getMinMaxDate(l,"min"),h=this._getMinMaxDate(l,"max"),K(l.settings,e),null!==g&&void 0!==e.dateFormat&&void 0===e.minDate&&(l.settings.minDate=this._formatDate(l,g)),null!==h&&void 0!==e.dateFormat&&void 0===e.maxDate&&(l.settings.maxDate=this._formatDate(l,
    ...
    d.datepicker._adjustDate(a.target,h?-1:1,"D");g=a.ctrlKey||a.metaKey;a.originalEvent.altKey&&d.datepicker._adjustDate(a.target,a.ctrlKey?+d.datepicker._get(f,"stepBigMonths"):+d.datepicker._get(f,"stepMonths"),"M");break;case 40:(a.ctrlKey||a.metaKey)&&d.datepicker._adjustDate(a.target,7,"D");g=a.ctrlKey||a.metaKey;break;default:g=!1}else 36===a.keyCode&&a.ctrlKey?d.datepicker._showDatepicker(this):g=!1;g&&(a.preventDefault(),a.stopPropagation())},_doKeyPress:function(a){var b,c,e=d.datepicker._getInst(a.target);
        ...
        c.apply(a,[a,b]):{};!1!==c&&(K(b.settings,c),b.lastVal=null,d.datepicker._lastInput=a,d.datepicker._setDateFromField(b),d.datepicker._inDialog&&(a.value=""),d.datepicker._pos||(d.datepicker._pos=d.datepicker._findPos(a),d.datepicker._pos[1]+=a.offsetHeight),e=!1,d(a).parents().each(function(){return e|="fixed"===d(this).css("position"),!e}),f={left:d.datepicker._pos[0],top:d.datepicker._pos[1]},d.datepicker._pos=null,b.dpDiv.empty(),b.dpDiv.css({position:"absolute",display:"block",top:"-1000px"}),
        ...
        d.datepicker._curInst=b))}},_updateDatepicker:function(a){this.maxRows=4;R=a;a.dpDiv.empty().append(this._generateHTML(a));this._attachHandlers(a);a.dpDiv.find("."+this._dayOverClass+" a");var b,c=this._getNumberOfMonths(a),e=c[1];a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");1<e&&a.dpDiv.addClass("ui-datepicker-multi-"+e).css("width",17*e+"em");a.dpDiv[(1!==c[0]||1!==c[1]?"add":"remove")+"Class"]("ui-datepicker-multi");a.dpDiv[(this._get(a,"isRTL")?
        ...
        f=a.dpDiv.outerHeight(),g=a.input?a.input.outerWidth():0,h=a.input?a.input.outerHeight():0,l=document.documentElement.clientWidth+(c?0:d(document).scrollLeft()),k=document.documentElement.clientHeight+(c?0:d(document).scrollTop());return b.left-=this._get(a,"isRTL")?e-g:0,b.left-=c&&b.left===a.input.offset().left?d(document).scrollLeft():0,b.top-=c&&b.top===a.input.offset().top+h?d(document).scrollTop():0,b.left-=Math.min(b.left,b.left+e>l&&l>e?Math.abs(b.left+e-l):0),b.top-=Math.min(b.top,b.top+
    f>k&&k>f?Math.abs(f+h):0),b},_findPos:function(a){for(var b,c=this._getInst(a),c=this._get(c,"isRTL");a&&("hidden"===a.type||1!==a.nodeType||d.expr.filters.hidden(a));)a=a[c?"previousSibling":"nextSibling"];return b=d(a).offset(),[b.left,b.top]},_hideDatepicker:function(a){var b,c,e,f,g=this._curInst;!g||a&&g!==d.data(a,"datepicker")||this._datepickerShowing&&(b=this._get(g,"showAnim"),c=this._get(g,"duration"),e=function(){d.datepicker._tidyDialog(g)},d.effects&&(d.effects.effect[b]||d.effects[b])?
        ...
        _checkExternalClick:function(a){if(d.datepicker._curInst){a=d(a.target);var b=d.datepicker._getInst(a[0]);(!(a[0].id===d.datepicker._mainDivId||0!==a.parents("#"+d.datepicker._mainDivId).length||a.hasClass(d.datepicker.markerClassName)||a.closest("."+d.datepicker._triggerClass).length||!d.datepicker._datepickerShowing||d.datepicker._inDialog&&d.blockUI)||a.hasClass(d.datepicker.markerClassName)&&d.datepicker._curInst!==b)&&d.datepicker._hideDatepicker()}},_adjustDate:function(a,b,c){a=d(a);var e=
            ...
            null)},_updateAlternate:function(a){var b,c,e,f=this._get(a,"altField");f&&(b=this._get(a,"altFormat")||this._get(a,"dateFormat"),c=this._getDate(a),e=this.formatDate(b,c,this._getFormatConfig(a)),d(f).each(function(){d(this).val(e)}))},noWeekends:function(a){a=a.getDay();return[0<a&&6>a,""]},iso8601Week:function(a){var b;a=new Date(a.getTime());return a.setDate(a.getDate()+4-(a.getDay()||7)),b=a.getTime(),a.setMonth(0),a.setDate(1),Math.floor(Math.round((b-a)/864E5)/7)+1},parseDate:function(a,b,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             c){if(null==a||null==b)throw"Invalid arguments";if(b="object"==typeof b?""+b:b+"",""===b)return null;var e,f,g,h,l=0,k=(c?c.shortYearCutoff:null)||this._defaults.shortYearCutoff,k="string"!=typeof k?k:(new Date).getFullYear()%100+parseInt(k,10),m=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort,n=(c?c.dayNames:null)||this._defaults.dayNames,p=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort;c=(c?c.monthNames:null)||this._defaults.monthNames;var r=-1,u=-1,q=-1,t=-1,v=!1,A=function(b){b=
            a.length>e+1&&a.charAt(e+1)===b;return b&&e++,b},C=function(a){var c=A(a);a=RegExp("^\\d{1,"+("@"===a?14:"!"===a?20:"y"===a&&c?4:"o"===a?3:2)+"}");a=b.substring(l).match(a);if(!a)throw"Missing number at position "+l;return l+=a[0].length,parseInt(a[0],10)},B=function(a,c,e){var f=-1;a=d.map(A(a)?e:c,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)});if(d.each(a,function(a,c){var d=c[1];return b.substr(l,d.length).toLowerCase()===d.toLowerCase()?(f=c[0],l+=d.length,
                !1):void 0}),-1!==f)return f+1;throw"Unknown name at position "+l;},w=function(){if(b.charAt(l)!==a.charAt(e))throw"Unexpected literal at position "+l;l++};for(e=0;a.length>e;e++)if(v)"'"!==a.charAt(e)||A("'")?w():v=!1;else switch(a.charAt(e)){case "d":q=C("d");break;case "D":B("D",m,n);break;case "o":t=C("o");break;case "m":u=C("m");break;case "M":u=B("M",p,c);break;case "y":r=C("y");break;case "@":h=new Date(C("@"));r=h.getFullYear();u=h.getMonth()+1;q=h.getDate();break;case "!":h=new Date((C("!")-
        this._ticksTo1970)/1E4);r=h.getFullYear();u=h.getMonth()+1;q=h.getDate();break;case "'":A("'")?w():v=!0;break;default:w()}if(b.length>l&&(g=b.substr(l),!/^\s+/.test(g)))throw"Extra/unparsed characters found in date: "+g;if(-1===r?r=(new Date).getFullYear():100>r&&(r+=(new Date).getFullYear()-(new Date).getFullYear()%100+(k>=r?0:-100)),-1<t)for(u=1,q=t;!(f=this._getDaysInMonth(r,u-1),f>=q);)u++,q-=f;if(h=this._daylightSavingAdjust(new Date(r,u-1,q)),h.getFullYear()!==r||h.getMonth()+1!==u||h.getDate()!==
            ...
            this._defaults.monthNamesShort;c=(c?c.monthNames:null)||this._defaults.monthNames;var l=function(b){b=a.length>d+1&&a.charAt(d+1)===b;return b&&d++,b},k=function(a,b,c){b=""+b;if(l(a))for(;c>b.length;)b="0"+b;return b},m=function(a,b,c,d){return l(a)?d[b]:c[b]},n="",p=!1;if(b)for(d=0;a.length>d;d++)if(p)"'"!==a.charAt(d)||l("'")?n+=a.charAt(d):p=!1;else switch(a.charAt(d)){case "d":n+=k("d",b.getDate(),2);break;case "D":n+=m("D",b.getDay(),f,g);break;case "o":n+=k("o",Math.round(((new Date(b.getFullYear(),
            b.getMonth(),b.getDate())).getTime()-(new Date(b.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":n+=k("m",b.getMonth()+1,2);break;case "M":n+=m("M",b.getMonth(),h,c);break;case "y":n+=l("y")?b.getFullYear():(10>b.getYear()%100?"0":"")+b.getYear()%100;break;case "@":n+=b.getTime();break;case "!":n+=1E4*b.getTime()+this._ticksTo1970;break;case "'":l("'")?n+="'":p=!0;break;default:n+=a.charAt(d)}return n},_possibleChars:function(a){var b,c="",d=!1,f=function(c){c=a.length>b+1&&a.charAt(b+1)===
        ...
        a),b},f=function(b){try{return d.datepicker.parseDate(d.datepicker._get(a,"dateFormat"),b,d.datepicker._getFormatConfig(a))}catch(c){}for(var e=(b.toLowerCase().match(/^c/)?d.datepicker._getDate(a):null)||new Date,f=e.getFullYear(),k=e.getMonth(),e=e.getDate(),m=/([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,n=m.exec(b);n;){switch(n[2]||"d"){case "d":case "D":e+=parseInt(n[1],10);break;case "w":case "W":e+=7*parseInt(n[1],10);break;case "m":case "M":k+=parseInt(n[1],10);e=Math.min(e,d.datepicker._getDaysInMonth(f,
            ...
            this),!1},selectMonth:function(){return d.datepicker._selectMonthYear(c,this,"M"),!1},selectYear:function(){return d.datepicker._selectMonthYear(c,this,"Y"),!1}}[this.getAttribute("data-handler")])})},_generateHTML:function(a){var b,c,d,f,g,h,l,k,m,n,p,r,u,q,t,v,A,C,B,w,E,y,J,L,N,M,Q,D=new Date,D=this._daylightSavingAdjust(new Date(D.getFullYear(),D.getMonth(),D.getDate())),H=this._get(a,"isRTL");h=this._get(a,"showButtonPanel");d=this._get(a,"hideIfNoPrevNext");g=this._get(a,"navigationAsDateFormat");
            var I=this._getNumberOfMonths(a),z=this._get(a,"showCurrentAtPos");f=this._get(a,"stepMonths");var K=1!==I[0]||1!==I[1],O=this._daylightSavingAdjust(a.currentDay?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,9)),x=this._getMinMaxDate(a,"min"),G=this._getMinMaxDate(a,"max"),z=a.drawMonth-z,F=a.drawYear;if(0>z&&(z+=12,F--),G)for(b=this._daylightSavingAdjust(new Date(G.getFullYear(),G.getMonth()-I[0]*I[1]+1,G.getDate())),b=x&&x>b?x:b;this._daylightSavingAdjust(new Date(F,z,1))>
            ...
            (H?"e":"w")+"'>"+b+"</span></a>";c=this._get(a,"nextText");c=g?this.formatDate(c,this._daylightSavingAdjust(new Date(F,z+f,1)),this._getFormatConfig(a)):c;d=this._canAdjustMonth(a,1,F,z)?"<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='"+c+"'><span class='ui-icon ui-icon-circle-triangle-"+(H?"w":"e")+"'>"+c+"</span></a>":d?"":"<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='"+c+"'><span class='ui-icon ui-icon-circle-triangle-"+(H?"w":
                "e")+"'>"+c+"</span></a>";f=this._get(a,"currentText");c=this._get(a,"gotoCurrent")&&a.currentDay?O:D;f=g?this.formatDate(f,c,this._getFormatConfig(a)):f;g=a.inline?"":"<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>"+this._get(a,"closeText")+"</button>";h=h?"<div class='ui-datepicker-buttonpane ui-widget-content'>"+(H?g:"")+(this._isInRange(a,c)?"<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>"+
            f+"</button>":"")+(H?"":g)+"</div>":"";g=parseInt(this._get(a,"firstDay"),10);g=isNaN(g)?0:g;f=this._get(a,"showWeek");c=this._get(a,"dayNames");l=this._get(a,"dayNamesMin");k=this._get(a,"monthNames");m=this._get(a,"monthNamesShort");n=this._get(a,"beforeShowDay");p=this._get(a,"showOtherMonths");r=this._get(a,"selectOtherMonths");u=this._getDefaultDate(a);q="";for(v=0;I[0]>v;v++){A="";this.maxRows=4;for(C=0;I[1]>C;C++){if(B=this._daylightSavingAdjust(new Date(F,z,a.selectedDay)),t=" ui-corner-all",
                    w="",K){if(w+="<div class='ui-datepicker-group",1<I[1])switch(C){case 0:w+=" ui-datepicker-group-first";t=" ui-corner-"+(H?"right":"left");break;case I[1]-1:w+=" ui-datepicker-group-last";t=" ui-corner-"+(H?"left":"right");break;default:w+=" ui-datepicker-group-middle",t=""}w+="'>"}w+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+t+"'>"+(/all|left/.test(t)&&0===v?H?d:b:"")+(/all|right/.test(t)&&0===v?H?b:d:"")+this._generateMonthYearHeader(a,z,F,x,G,0<v||0<C,k,m)+"</div><table class='ui-datepicker-calendar'><thead><tr>";
                E=f?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(t=0;7>t;t++)y=(t+g)%7,E+="<th scope='col'"+(5<=(t+g+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+c[y]+"'>"+l[y]+"</span></th>";w+=E+"</tr></thead><tbody>";E=this._getDaysInMonth(F,z);F===a.selectedYear&&z===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,E));t=(this._getFirstDayOfMonth(F,z)-g+7)%7;E=Math.ceil((t+E)/7);this.maxRows=E=K?this.maxRows>E?this.maxRows:E:E;y=this._daylightSavingAdjust(new Date(F,
                    z,1-t));for(J=0;E>J;J++){w+="<tr>";L=f?"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(y)+"</td>":"";for(t=0;7>t;t++)N=n?n.apply(a.input?a.input[0]:null,[y]):[!0,""],Q=(M=y.getMonth()!==z)&&!r||!N[0]||x&&x>y||G&&y>G,L+="<td class='"+(5<=(t+g+6)%7?" ui-datepicker-week-end":"")+(M?" ui-datepicker-other-month":"")+(y.getTime()===B.getTime()&&z===a.selectedMonth&&a._keyEvent||u.getTime()===y.getTime()&&u.getTime()===B.getTime()?" "+this._dayOverClass:"")+(Q?" "+this._unselectableClass+
                " ui-state-disabled":"")+(M&&!p?"":" "+N[1]+(y.getTime()===O.getTime()?" "+this._currentClass:"")+(y.getTime()===D.getTime()?" ui-datepicker-today":""))+"'"+(M&&!p||!N[2]?"":" title='"+N[2].replace(/'/g,"&#39;")+"'")+(Q?"":" data-handler='selectDay' data-event='click' data-month='"+y.getMonth()+"' data-year='"+y.getFullYear()+"'")+">"+(M&&!p?"&#xa0;":Q?"<span class='ui-state-default'>"+y.getDate()+"</span>":"<a class='ui-state-default"+(y.getTime()===D.getTime()?" ui-state-highlight":"")+(y.getTime()===
                O.getTime()?" ui-state-active":"")+(M?" ui-priority-secondary":"")+"' href='#'>"+y.getDate()+"</a>")+"</td>",y.setDate(y.getDate()+1),y=this._daylightSavingAdjust(y);w+=L+"</tr>"}z++;11<z&&(z=0,F++);w+="</tbody></table>"+(K?"</div>"+(0<I[0]&&C===I[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");A+=w}q+=A}return q+=h,a._keyEvent=!1,q},_generateMonthYearHeader:function(a,b,c,d,f,g,h,l){var k,m,n,p=this._get(a,"changeMonth"),r=this._get(a,"changeYear"),u=this._get(a,"showMonthAfterYear"),
            q="<div class='ui-datepicker-title'>",t="";if(g||!p)t+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=d&&d.getFullYear()===c;k=f&&f.getFullYear()===c;t+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";for(m=0;12>m;m++)(!h||m>=d.getMonth())&&(!k||f.getMonth()>=m)&&(t+="<option value='"+m+"'"+(m===b?" selected='selected'":"")+">"+l[m]+"</option>");t+="</select>"}if(u||(q+=t+(!g&&p&&r?"":"&#xa0;")),!a.yearshtml)if(a.yearshtml="",g||!r)q+="<span class='ui-datepicker-year'>"+
        c+"</span>";else{l=this._get(a,"yearRange").split(":");n=(new Date).getFullYear();h=function(a){a=a.match(/c[+\-].*/)?c+parseInt(a.substring(1),10):a.match(/[+\-].*/)?n+parseInt(a,10):parseInt(a,10);return isNaN(a)?n:a};b=h(l[0]);l=Math.max(b,h(l[1]||""));b=d?Math.max(b,d.getFullYear()):b;l=f?Math.min(l,f.getFullYear()):l;for(a.yearshtml+="<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>";l>=b;b++)a.yearshtml+="<option value='"+b+"'"+(b===c?" selected='selected'":
            "")+">"+b+"</option>";a.yearshtml+="</select>";q+=a.yearshtml;a.yearshtml=null}return q+=this._get(a,"yearSuffix"),u&&(q+=(!g&&p&&r?"":"&#xa0;")+t),q+="</div>"},_adjustInstDate:function(a,b,c){var d=a.drawYear+("Y"===c?b:0),f=a.drawMonth+("M"===c?b:0);b=Math.min(a.selectedDay,this._getDaysInMonth(d,f))+("D"===c?b:0);d=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(d,f,b)));a.selectedDay=d.getDate();a.drawMonth=a.selectedMonth=d.getMonth();a.drawYear=a.selectedYear=d.getFullYear();"M"!==
        ...
        a+"Datepicker"].apply(d.datepicker,[this].concat(b)):d.datepicker._attachDatepicker(this,a)}):d.datepicker["_"+a+"Datepicker"].apply(d.datepicker,[this[0]].concat(b))};d.datepicker=new V;d.datepicker.initialized=!1;d.datepicker.uuid=(new Date).getTime();d.datepicker.version="1.11.0";d.datepicker;d.widget("ui.draggable",d.ui.mouse,{version:"1.11.0",widgetEventPrefix:"drag",options:{addClasses:!0,appendTo:"parent",axis:!1,connectToSortable:!1,containment:!1,cursor:"auto",cursorAt:!1,grid:!1,handle:!1,
    ...
    this.margins.top],void 0):e.containment.constructor===Array?(this.containment=e.containment,void 0):("parent"===e.containment&&(e.containment=this.helper[0].parentNode),b=d(e.containment),c=b[0],c&&(a="hidden"!==b.css("overflow"),this.containment=[(parseInt(b.css("borderLeftWidth"),10)||0)+(parseInt(b.css("paddingLeft"),10)||0),(parseInt(b.css("borderTopWidth"),10)||0)+(parseInt(b.css("paddingTop"),10)||0),(a?Math.max(c.scrollWidth,c.offsetWidth):c.offsetWidth)-(parseInt(b.css("borderRightWidth"),
        ...
        return{top:b.top+this.offset.relative.top*c+this.offset.parent.top*c-("fixed"===this.cssPosition?-this.offset.scroll.top:d?0:this.offset.scroll.top)*c,left:b.left+this.offset.relative.left*c+this.offset.parent.left*c-("fixed"===this.cssPosition?-this.offset.scroll.left:d?0:this.offset.scroll.left)*c}},_generatePosition:function(a,b){var c,d,f,g,h=this.options,l=this._isRootNode(this.scrollParent[0]),k=a.pageX,m=a.pageY;return l&&this.offset.scroll||(this.offset.scroll={top:this.scrollParent.scrollTop(),
        left:this.scrollParent.scrollLeft()}),b&&(this.containment&&(this.relative_container?(d=this.relative_container.offset(),c=[this.containment[0]+d.left,this.containment[1]+d.top,this.containment[2]+d.left,this.containment[3]+d.top]):c=this.containment,a.pageX-this.offset.click.left<c[0]&&(k=c[0]+this.offset.click.left),a.pageY-this.offset.click.top<c[1]&&(m=c[1]+this.offset.click.top),a.pageX-this.offset.click.left>c[2]&&(k=c[2]+this.offset.click.left),a.pageY-this.offset.click.top>c[3]&&(m=c[3]+this.offset.click.top)),
    h.grid&&(f=h.grid[1]?this.originalPageY+Math.round((m-this.originalPageY)/h.grid[1])*h.grid[1]:this.originalPageY,m=c?f-this.offset.click.top>=c[1]||f-this.offset.click.top>c[3]?f:f-this.offset.click.top>=c[1]?f-h.grid[1]:f+h.grid[1]:f,g=h.grid[0]?this.originalPageX+Math.round((k-this.originalPageX)/h.grid[0])*h.grid[0]:this.originalPageX,k=c?g-this.offset.click.left>=c[0]||g-this.offset.click.left>c[2]?g:g-this.offset.click.left>=c[0]?g-h.grid[0]:g+h.grid[0]:g),"y"===h.axis&&(k=this.originalPageX),
    ...
    b.scrollSpeed):d(window).height()-(a.pageY-d(f).scrollTop())<b.scrollSensitivity&&(e=d(f).scrollTop(d(f).scrollTop()+b.scrollSpeed))),b.axis&&"y"===b.axis||(a.pageX-d(f).scrollLeft()<b.scrollSensitivity?e=d(f).scrollLeft(d(f).scrollLeft()-b.scrollSpeed):d(window).width()-(a.pageX-d(f).scrollLeft())<b.scrollSensitivity&&(e=d(f).scrollLeft(d(f).scrollLeft()+b.scrollSpeed))));!1!==e&&d.ui.ddmanager&&!b.dropBehaviour&&d.ui.ddmanager.prepareOffsets(c,a)}});d.ui.plugin.add("draggable","snap",{start:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               b,c){a=c.options;c.snapElements=[];d(a.snap.constructor!==String?a.snap.items||":data(ui-draggable)":a.snap).each(function(){var a=d(this),b=a.offset();this!==c.element[0]&&c.snapElements.push({item:this,width:a.outerWidth(),height:a.outerHeight(),top:b.top,left:b.left})})},drag:function(a,b,c){var e,f,g,h,l,k,m,n,p,r,u=c.options,q=u.snapTolerance,t=b.offset.left,v=t+c.helperProportions.width,A=b.offset.top,C=A+c.helperProportions.height;for(p=c.snapElements.length-1;0<=p;p--)l=c.snapElements[p].left,
        k=l+c.snapElements[p].width,m=c.snapElements[p].top,n=m+c.snapElements[p].height,l-q>v||t>k+q||m-q>C||A>n+q||!d.contains(c.snapElements[p].item.ownerDocument,c.snapElements[p].item)?(c.snapElements[p].snapping&&c.options.snap.release&&c.options.snap.release.call(c.element,a,d.extend(c._uiHash(),{snapItem:c.snapElements[p].item})),c.snapElements[p].snapping=!1):("inner"!==u.snapMode&&(e=q>=Math.abs(m-C),f=q>=Math.abs(n-A),g=q>=Math.abs(l-v),h=q>=Math.abs(k-t),e&&(b.position.top=c._convertPositionTo("relative",
        {top:m-c.helperProportions.height,left:0}).top-c.margins.top),f&&(b.position.top=c._convertPositionTo("relative",{top:n,left:0}).top-c.margins.top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:l-c.helperProportions.width}).left-c.margins.left),h&&(b.position.left=c._convertPositionTo("relative",{top:0,left:k}).left-c.margins.left)),r=e||f||g||h,"outer"!==u.snapMode&&(e=q>=Math.abs(m-A),f=q>=Math.abs(n-C),g=q>=Math.abs(l-t),h=q>=Math.abs(k-v),e&&(b.position.top=c._convertPositionTo("relative",
        {top:m,left:0}).top-c.margins.top),f&&(b.position.top=c._convertPositionTo("relative",{top:n-c.helperProportions.height,left:0}).top-c.margins.top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:l}).left-c.margins.left),h&&(b.position.left=c._convertPositionTo("relative",{top:0,left:k-c.helperProportions.width}).left-c.margins.left)),!c.snapElements[p].snapping&&(e||f||g||h||r)&&c.options.snap.snap&&c.options.snap.snap.call(c.element,a,d.extend(c._uiHash(),{snapItem:c.snapElements[p].item})),
        c.snapElements[p].snapping=e||f||g||h||r)}});d.ui.plugin.add("draggable","stack",{start:function(a,b,c){var e;a=d.makeArray(d(c.options.stack)).sort(function(a,b){return(parseInt(d(a).css("zIndex"),10)||0)-(parseInt(d(b).css("zIndex"),10)||0)});a.length&&(e=parseInt(d(a[0]).css("zIndex"),10)||0,d(a).each(function(a){d(this).css("zIndex",e+a)}),this.css("zIndex",e+a.length))}});d.ui.plugin.add("draggable","zIndex",{start:function(a,b,c){a=d(b.helper);c=c.options;a.css("zIndex")&&(c._zIndex=a.css("zIndex"));
    ...
    (e.left=this.position.left+"px"),this.size.width!==this.prevSize.width&&(e.width=this.size.width+"px"),this.size.height!==this.prevSize.height&&(e.height=this.size.height+"px"),c.css(e),!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize(),d.isEmptyObject(e)||this._trigger("resize",a,this.ui()),!1):!1},_mouseStop:function(a){this.resizing=!1;var b,c,e,f,g,h,l,k=this.options;return this._helper&&(b=this._proportionallyResizeElements,c=b.length&&/textarea/i.test(b[0].nodeName),
        ...
        b.minWidth>a.width,h=this._isNumber(a.height)&&b.minHeight&&b.minHeight>a.height,l=this.originalPosition.left+this.originalSize.width,k=this.position.top+this.size.height,m=/sw|nw|w/.test(c),c=/nw|ne|n/.test(c);return g&&(a.width=b.minWidth),h&&(a.height=b.minHeight),d&&(a.width=b.maxWidth),f&&(a.height=b.maxHeight),g&&m&&(a.left=l-b.minWidth),d&&m&&(a.left=l-b.maxWidth),h&&c&&(a.top=k-b.minHeight),f&&c&&(a.top=k-b.maxHeight),a.width||a.height||a.left||!a.top?a.width||a.height||a.top||!a.left||(a.left=
    ...
    g},g=parseInt(b.element.css("left"),10)+(b.position.left-b.originalPosition.left)||null,h=parseInt(b.element.css("top"),10)+(b.position.top-b.originalPosition.top)||null;b.element.animate(d.extend(f,h&&g?{top:h,left:g}:{}),{duration:c.animateDuration,easing:c.animateEasing,step:function(){var c={width:parseInt(b.element.css("width"),10),height:parseInt(b.element.css("height"),10),top:parseInt(b.element.css("top"),10),left:parseInt(b.element.css("left"),10)};e&&e.length&&d(e[0]).css({width:c.width,
        height:c.height});b._updateCache(c);b._propagate("resize",a)}})}});d.ui.plugin.add("resizable","containment",{start:function(){var a,b,c,e,f,g,h,l=d(this).resizable("instance"),k=l.element,m=l.options.containment;(k=m instanceof d?m.get(0):/parent/.test(m)?k.parent().get(0):m)&&(l.containerElement=d(k),/document/.test(m)||m===document?(l.containerOffset={left:0,top:0},l.containerPosition={left:0,top:0},l.parentData={element:d(document),left:0,top:0,width:d(document).width(),height:d(document).height()||
    document.body.parentNode.scrollHeight}):(a=d(k),b=[],d(["Top","Right","Left","Bottom"]).each(function(c,d){b[c]=l._num(a.css("padding"+d))}),l.containerOffset=a.offset(),l.containerPosition=a.position(),l.containerSize={height:a.innerHeight()-b[3],width:a.innerWidth()-b[1]},c=l.containerOffset,e=l.containerSize.height,f=l.containerSize.width,g=l._hasScroll(k,"left")?k.scrollWidth:f,h=l._hasScroll(k)?k.scrollHeight:e,l.parentData={element:k,left:c.left,top:c.top,width:g,height:h}))},resize:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           b){var c,e,f,g,h=d(this).resizable("instance");c=h.options;e=h.containerOffset;g=h.position;var l=h._aspectRatio||a.shiftKey;f={top:0,left:0};var k=h.containerElement,m=!0;k[0]!==document&&/static/.test(k.css("position"))&&(f=e);g.left<(h._helper?e.left:0)&&(h.size.width+=h._helper?h.position.left-e.left:h.position.left-f.left,l&&(h.size.height=h.size.width/h.aspectRatio,m=!1),h.position.left=c.helper?e.left:0);g.top<(h._helper?e.top:0)&&(h.size.height+=h._helper?h.position.top-e.top:h.position.top,
    l&&(h.size.width=h.size.height*h.aspectRatio,m=!1),h.position.top=h._helper?e.top:0);h.offset.left=h.parentData.left+h.position.left;h.offset.top=h.parentData.top+h.position.top;c=Math.abs((h._helper?h.offset.left-f.left:h.offset.left-e.left)+h.sizeDiff.width);e=Math.abs((h._helper?h.offset.top-f.top:h.offset.top-e.top)+h.sizeDiff.height);f=h.containerElement.get(0)===h.element.parent().get(0);g=/relative|absolute/.test(h.containerElement.css("position"));f&&g&&(c-=Math.abs(h.parentData.left));c+
    h.size.width>=h.parentData.width&&(h.size.width=h.parentData.width-c,l&&(h.size.height=h.size.width/h.aspectRatio,m=!1));e+h.size.height>=h.parentData.height&&(h.size.height=h.parentData.height-e,l&&(h.size.width=h.size.height*h.aspectRatio,m=!1));m||(h.position.left=b.prevPosition.left,h.position.top=b.prevPosition.top,h.size.width=b.prevSize.width,h.size.height=b.prevSize.height)},stop:function(){var a=d(this).resizable("instance"),b=a.options,c=a.containerOffset,e=a.containerPosition,f=a.containerElement,
        g=d(a.helper),h=g.offset(),l=g.outerWidth()-a.sizeDiff.width,g=g.outerHeight()-a.sizeDiff.height;a._helper&&!b.animate&&/relative/.test(f.css("position"))&&d(this).css({left:h.left-e.left-c.left,width:l,height:g});a._helper&&!b.animate&&/static/.test(f.css("position"))&&d(this).css({left:h.left-e.left-c.left,width:l,height:g})}});d.ui.plugin.add("resizable","alsoResize",{start:function(){var a=d(this).resizable("instance").options,b=function(a){d(a).each(function(){var a=d(this);a.data("ui-resizable-alsoresize",
    ...
    0,left:c.position.left-g.left||0},l=function(a,c){d(a).each(function(){var a=d(this),e=d(this).data("ui-resizable-alsoresize"),f={},g=c&&c.length?c:a.parents(b.originalElement[0]).length?["width","height"]:["width","height","top","left"];d.each(g,function(a,b){var c=(e[b]||0)+(h[b]||0);c&&0<=c&&(f[b]=c||null)});a.css(f)})};"object"!=typeof e.alsoResize||e.alsoResize.nodeType?l(e.alsoResize):d.each(e.alsoResize,function(a,b){l(a,b)})},stop:function(){d(this).removeData("resizable-alsoresize")}});d.ui.plugin.add("resizable",
        "ghost",{start:function(){var a=d(this).resizable("instance"),b=a.options,c=a.size;a.ghost=a.originalElement.clone();a.ghost.css({opacity:.25,display:"block",position:"relative",height:c.height,width:c.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass("string"==typeof b.ghost?b.ghost:"");a.ghost.appendTo(a.helper)},resize:function(){var a=d(this).resizable("instance");a.ghost&&a.ghost.css({position:"relative",height:a.size.height,width:a.size.width})},stop:function(){var a=d(this).resizable("instance");
            a.ghost&&a.helper&&a.helper.get(0).removeChild(a.ghost.get(0))}});d.ui.plugin.add("resizable","grid",{resize:function(){var a=d(this).resizable("instance"),b=a.options,c=a.size,e=a.originalSize,f=a.originalPosition,g=a.axis,h="number"==typeof b.grid?[b.grid,b.grid]:b.grid,l=h[0]||1,k=h[1]||1,m=Math.round((c.width-e.width)/l)*l,c=Math.round((c.height-e.height)/k)*k,n=e.width+m,p=e.height+c,r=b.maxWidth&&n>b.maxWidth,u=b.maxHeight&&p>b.maxHeight,q=b.minWidth&&b.minWidth>n,t=b.minHeight&&b.minHeight>
        p;b.grid=h;q&&(n+=l);t&&(p+=k);r&&(n-=l);u&&(p-=k);/^(se|s|e)$/.test(g)?(a.size.width=n,a.size.height=p):/^(ne)$/.test(g)?(a.size.width=n,a.size.height=p,a.position.top=f.top-c):/^(sw)$/.test(g)?(a.size.width=n,a.size.height=p,a.position.left=f.left-m):(0<p-k?(a.size.height=p,a.position.top=f.top-c):(a.size.height=k,a.position.top=f.top+e.height-k),0<n-l?(a.size.width=n,a.position.left=f.left-m):(a.size.width=l,a.position.left=f.left+e.width-l))}});d.ui.resizable;d.widget("ui.dialog",{version:"1.11.0",
    ...
    a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});d.ui.intersect=function(){return function(a,b,c){if(!b.offset)return!1;var d=(a.positionAbs||a.position.absolute).left,f=(a.positionAbs||a.position.absolute).top,g=d+a.helperProportions.width,h=f+a.helperProportions.height,l=b.offset.left,k=b.offset.top,m=l+b.proportions().width,n=k+b.proportions().height;switch(c){case "fit":return d>=l&&m>=g&&f>=k&&n>=h;case "intersect":return d+a.helperProportions.width/2>l&&m>g-a.helperProportions.width/
        2&&f+a.helperProportions.height/2>k&&n>h-a.helperProportions.height/2;case "pointer":c=(a.positionAbs||a.position.absolute).left+(a.clickOffset||a.offset.click).left;a=(a.positionAbs||a.position.absolute).top+(a.clickOffset||a.offset.click).top;d=b.proportions().height;if(k=a>=k&&k+d>a)b=b.proportions().width,k=c>=l&&l+b>c;return k;case "touch":return(f>=k&&n>=f||h>=k&&n>=h||k>f&&h>n)&&(d>=l&&m>=d||g>=l&&m>=g||l>d&&g>m);default:return!1}}}();d.ui.ddmanager={current:null,droppables:{"default":[]},
        ...
        d.ui.ddmanager.prepareOffsets(a,b)}};d.ui.droppable;d.effects={effect:{}};(function(a,b){function c(a,b,c){var d=n[b.type]||{};return null==a?c||!b.def?null:b.def:(a=d.floor?~~a:parseFloat(a),isNaN(a)?b.def:d.mod?(a+d.mod)%d.mod:0>a?0:a>d.max?d.max:a)}function d(c){var e=k(),f=e._rgba=[];return c=c.toLowerCase(),u(l,function(a,d){var g,h=d.re.exec(c),h=h&&d.parse(h),k=d.space||"rgba";return h?(g=e[k](h),e[m[k].cache]=g[m[k].cache],f=e._rgba=g._rgba,!1):b}),f.length?("0,0,0,0"===f.join()&&a.extend(f,
        g.transparent),e):g[c]}function f(a,b,c){return c=(c+1)%1,1>6*c?a+6*(b-a)*c:1>2*c?b:2>3*c?a+6*(b-a)*(2/3-c):a}var g,h=/^([\-+])=\s*(\d+\.?\d*)/,l=[{re:/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(a){return[a[1],a[2],a[3],a[4]]}},{re:/rgba?\(\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(a){return[2.55*a[1],2.55*a[2],2.55*a[3],a[4]]}},{re:/#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})/,
        parse:function(a){return[parseInt(a[1],16),parseInt(a[2],16),parseInt(a[3],16)]}},{re:/#([a-f0-9])([a-f0-9])([a-f0-9])/,parse:function(a){return[parseInt(a[1]+a[1],16),parseInt(a[2]+a[2],16),parseInt(a[3]+a[3],16)]}},{re:/hsla?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,space:"hsla",parse:function(a){return[a[1],a[2]/100,a[3]/100,a[4]]}}],k=a.Color=function(b,c,d,e){return new a.Color.fn.parse(b,c,d,e)},m={rgba:{props:{red:{idx:0,type:"byte"},
        green:{idx:1,type:"byte"},blue:{idx:2,type:"byte"}}},hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},lightness:{idx:2,type:"percent"}}}},n={"byte":{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},p=k.support={},r=a("<p>")[0],u=a.each;r.style.cssText="background-color:rgba(1,1,1,.5)";p.rgba=-1<r.style.backgroundColor.indexOf("rgba");u(m,function(a,b){b.cache="_"+a;b.props.alpha={idx:3,type:"percent",def:1}});k.fn=a.extend(k.prototype,{parse:function(f,h,l,n){if(f===
        b)return this._rgba=[null,null,null,null],this;(f.jquery||f.nodeType)&&(f=a(f).css(h),h=b);var p=this,r=a.type(f),w=this._rgba=[];return h!==b&&(f=[f,h,l,n],r="array"),"string"===r?this.parse(d(f)||g._default):"array"===r?(u(m.rgba.props,function(a,b){w[b.idx]=c(f[b.idx],b)}),this):"object"===r?(f instanceof k?u(m,function(a,b){f[b.cache]&&(p[b.cache]=f[b.cache].slice())}):u(m,function(b,d){var e=d.cache;u(d.props,function(a,b){if(!p[e]&&d.to){if("alpha"===a||null==f[a])return;p[e]=d.to(p._rgba)}p[e][b.idx]=
        c(f[a],b,!0)});p[e]&&0>a.inArray(null,p[e].slice(0,3))&&(p[e][3]=1,d.from&&(p._rgba=d.from(p[e])))}),this):b},is:function(a){var c=k(a),d=!0,e=this;return u(m,function(a,f){var g,h=c[f.cache];return h&&(g=e[f.cache]||f.to&&f.to(e._rgba)||[],u(f.props,function(a,c){return null!=h[c.idx]?d=h[c.idx]===g[c.idx]:b})),d}),d},_space:function(){var a=[],b=this;return u(m,function(c,d){b[d.cache]&&a.push(c)}),a.pop()},transition:function(a,b){var d=k(a),e=d._space(),f=m[e],g=0===this.alpha()?k("transparent"):
        this,h=g[f.cache]||f.to(g._rgba),l=h.slice();return d=d[f.cache],u(f.props,function(a,e){var f=e.idx,g=h[f],k=d[f],m=n[e.type]||{};null!==k&&(null===g?l[f]=k:(m.mod&&(k-g>m.mod/2?g+=m.mod:g-k>m.mod/2&&(g-=m.mod)),l[f]=c((k-g)*b+g,e)))}),this[e](l)},blend:function(b){if(1===this._rgba[3])return this;var c=this._rgba.slice(),d=c.pop(),e=k(b)._rgba;return k(a.map(c,function(a,b){return(1-d)*e[b]+d*a}))},toRgbaString:function(){var b="rgba(",c=a.map(this._rgba,function(a,b){return null==a?2<b?1:0:a});
        ...
        k.fn;m.hsla.to=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b,c,d=a[0]/255,e=a[1]/255,f=a[2]/255;a=a[3];var g=Math.max(d,e,f),h=Math.min(d,e,f),k=g-h,l=g+h,m=.5*l;return b=h===g?0:d===g?60*(e-f)/k+360:e===g?60*(f-d)/k+120:60*(d-e)/k+240,c=0===k?0:.5>=m?k/l:k/(2-l),[Math.round(b)%360,c,m,null==a?1:a]};m.hsla.from=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/360,c=a[1],d=a[2];a=a[3];c=.5>=d?d*(1+c):d+c-d*c;d=2*d-c;return[Math.round(255*
    f(d,c,b+1/3)),Math.round(255*f(d,c,b)),Math.round(255*f(d,c,b-1/3)),a]};u(m,function(d,e){var f=e.props,g=e.cache,l=e.to,m=e.from;k.fn[d]=function(d){if(l&&!this[g]&&(this[g]=l(this._rgba)),d===b)return this[g].slice();var e,h=a.type(d),n="array"===h||"object"===h?d:arguments,p=this[g].slice();return u(f,function(a,b){var d=n["object"===h?a:b.idx];null==d&&(d=p[b.idx]);p[b.idx]=c(d,b)}),m?(e=k(m(p)),e[g]=p,e):k(p)};u(f,function(b,c){k.fn[b]||(k.fn[b]=function(e){var f,g=a.type(e),k="alpha"===b?this._hsla?
        "hsla":"rgba":d,l=this[k](),m=l[c.idx];return"undefined"===g?m:("function"===g&&(e=e.call(this,m),g=a.type(e)),null==e&&c.empty?this:("string"===g&&(f=h.exec(e),f&&(e=m+parseFloat(f[2])*("+"===f[1]?1:-1))),l[c.idx]=e,this[k](l)))})})});k.hook=function(b){b=b.split(" ");u(b,function(b,c){a.cssHooks[c]={set:function(b,f){var g,h="";if("transparent"!==f&&("string"!==a.type(f)||(g=d(f)))){if(f=k(g||f),!p.rgba&&1!==f._rgba[3]){for(g="backgroundColor"===c?b.parentNode:b;(""===h||"transparent"===h)&&g&&
    g.style;)try{h=a.css(g,"backgroundColor"),g=g.parentNode}catch(l){}f=f.blend(h&&"transparent"!==h?h:"_default")}f=f.toRgbaString()}try{b.style[c]=f}catch(l){}}};a.fx.step[c]=function(b){b.colorInit||(b.start=k(b.elem,c),b.end=k(b.end),b.colorInit=!0);a.cssHooks[c].set(b.elem,b.start.transition(b.end,b.pos))}})};k.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor");a.cssHooks.borderColor=
    {expand:function(a){var b={};return u(["Top","Right","Bottom","Left"],function(c,d){b["border"+d+"Color"]=a}),b}};g=a.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",olive:"#808000",purple:"#800080",red:"#ff0000",silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"}})(jQuery);(function(){function a(a){var b,c=a.ownerDocument.defaultView?
    ...
    a.end&&!a.setAttr||1===a.pos&&!a.setAttr)&&(jQuery.style(a.elem,b,a.end),a.setAttr=!0)}});d.fn.addBack||(d.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});d.effects.animateClass=function(e,f,g,h){var l=d.speed(f,g,h);return this.queue(function(){var f,g=d(this),h=g.attr("class")||"",p=l.children?g.find("*").addBack():g,p=p.map(function(){return{el:d(this),start:a(this)}});f=function(){d.each(b,function(a,b){e[b]&&g[b+"Class"](e[b])})};f();p=p.map(function(){this.end=
        a(this.el[0]);var b=this.start,e=this.end,f,g,h={};for(f in e)g=e[f],b[f]!==g&&(c[f]||(d.fx.step[f]||!isNaN(parseFloat(g)))&&(h[f]=g));return this.diff=h,this});g.attr("class",h);p=p.map(function(){var a=this,b=d.Deferred(),c=d.extend({},l,{queue:!1,complete:function(){b.resolve(a)}});return this.el.animate(this.diff,c),b.promise()});d.when.apply(d,p.get()).done(function(){f();d.each(arguments,function(){var a=this.el;d.each(this.diff,function(b){a.css(b,"")})});l.complete.call(g[0])})})};d.fn.extend({addClass:function(a){return function(b,
    ...
    "hide"===p:"show"===p)?(f[p](),c()):h.call(f[0],e,c)}var e=a.apply(this,arguments),f=e.mode,g=e.queue,h=d.effects.effect[e.effect];return d.fx.off||!h?f?this[f](e.duration,e.complete):this.each(function(){e.complete&&e.complete.call(this)}):!1===g?this.each(b):this.queue(g||"fx",b)},show:function(c){return function(d){if(b(d))return c.apply(this,arguments);var f=a.apply(this,arguments);return f.mode="show",this.effect.call(this,f)}}(d.fn.show),hide:function(c){return function(d){if(b(d))return c.apply(this,
        ...
        c(1-a)};d.easing["easeInOut"+a]=function(a){return.5>a?c(2*a)/2:1-c(-2*a+2)/2}})})();d.effects;d.effects.effect.blind=function(a,b){var c,e,f,g=d(this),h="position top bottom left right height width".split(" "),l=d.effects.setMode(g,a.mode||"hide");c=a.direction||"up";var k=/up|down|vertical/.test(c),m=k?"height":"width",n=k?"top":"left",p=/up|left|vertical|horizontal/.test(c),r={},u="show"===l;g.parent().is(".ui-effects-wrapper")?d.effects.save(g.parent(),h):d.effects.save(g,h);g.show();c=d.effects.createWrapper(g).css({overflow:"hidden"});
        e=c[m]();f=parseFloat(c.css(n))||0;r[m]=u?e:0;p||(g.css(k?"bottom":"right",0).css(k?"top":"left","auto").css({position:"absolute"}),r[n]=u?f:e+f);u&&(c.css(m,0),p||c.css(n,f+e));c.animate(r,{duration:a.duration,easing:a.easing,queue:!1,complete:function(){"hide"===l&&g.hide();d.effects.restore(g,h);d.effects.removeWrapper(g);b()}})};d.effects.effect.bounce=function(a,b){var c,e,f,g=d(this),h="position top bottom left right height width".split(" "),l=d.effects.setMode(g,a.mode||"effect"),k="hide"===
        l;c="show"===l;var m=a.direction||"up",l=a.distance,n=a.times||5,p=2*n+(c||k?1:0),r=a.duration/p,u=a.easing,q="up"===m||"down"===m?"top":"left",m="up"===m||"left"===m,t=g.queue(),v=t.length;(c||k)&&h.push("opacity");d.effects.save(g,h);g.show();d.effects.createWrapper(g);l||(l=g["top"===q?"outerHeight":"outerWidth"]()/3);c&&(f={opacity:1},f[q]=0,g.css("opacity",0).css(q,m?2*-l:2*l).animate(f,r,u));k&&(l/=Math.pow(2,n-1));f={};for(c=f[q]=0;n>c;c++)e={},e[q]=(m?"-=":"+=")+l,g.animate(e,r,u).animate(f,
        r,u),l=k?2*l:l/2;k&&(e={opacity:0},e[q]=(m?"-=":"+=")+l,g.animate(e,r,u));g.queue(function(){k&&g.hide();d.effects.restore(g,h);d.effects.removeWrapper(g);b()});1<v&&t.splice.apply(t,[1,0].concat(t.splice(v,p+1)));g.dequeue()};d.effects.effect.clip=function(a,b){var c,e,f=d(this),g="position top bottom left right height width".split(" "),h="show"===d.effects.setMode(f,a.mode||"hide"),l="vertical"===(a.direction||"vertical"),k=l?"height":"width",l=l?"top":"left",m={};d.effects.save(f,g);f.show();c=
        d.effects.createWrapper(f).css({overflow:"hidden"});c="IMG"===f[0].tagName?c:f;e=c[k]();h&&(c.css(k,0),c.css(l,e/2));m[k]=h?e:0;m[l]=h?0:e/2;c.animate(m,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){h||f.hide();d.effects.restore(f,g);d.effects.removeWrapper(f);b()}})};d.effects.effect.drop=function(a,b){var c,e=d(this),f="position top bottom left right opacity height width".split(" "),g=d.effects.setMode(e,a.mode||"hide"),h="show"===g;c=a.direction||"left";var l="up"===c||"down"===
    c?"top":"left",k="up"===c||"left"===c?"pos":"neg",m={opacity:h?1:0};d.effects.save(e,f);e.show();d.effects.createWrapper(e);c=a.distance||e["top"===l?"outerHeight":"outerWidth"](!0)/2;h&&e.css("opacity",0).css(l,"pos"===k?-c:c);m[l]=(h?"pos"===k?"+=":"-=":"pos"===k?"-=":"+=")+c;e.animate(m,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===g&&e.hide();d.effects.restore(e,f);d.effects.removeWrapper(e);b()}})};d.effects.effect.explode=function(a,b){function c(){v.push(this);
        v.length===m*n&&(p.css({visibility:"visible"}),d(v).remove(),r||p.hide(),b())}var e,f,g,h,l,k,m=a.pieces?Math.round(Math.sqrt(a.pieces)):3,n=m,p=d(this),r="show"===d.effects.setMode(p,a.mode||"hide"),u=p.show().css("visibility","hidden").offset(),q=Math.ceil(p.outerWidth()/n),t=Math.ceil(p.outerHeight()/m),v=[];for(e=0;m>e;e++)for(h=u.top+e*t,k=e-(m-1)/2,f=0;n>f;f++)g=u.left+f*q,l=f-(n-1)/2,p.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-f*q,top:-e*
    t}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:q,height:t,left:g+(r?l*q:0),top:h+(r?k*t:0),opacity:r?0:1}).animate({left:g+(r?0:l*q),top:h+(r?0:k*t),opacity:r?1:0},a.duration||500,a.easing,c)};d.effects.effect.fade=function(a,b){var c=d(this),e=d.effects.setMode(c,a.mode||"toggle");c.animate({opacity:e},{queue:!1,duration:a.duration,easing:a.easing,complete:b})};d.effects.effect.fold=function(a,b){var c,e,f=d(this),g="position top bottom left right height width".split(" ");
        c=d.effects.setMode(f,a.mode||"hide");var h="show"===c,l="hide"===c,k=a.size||15,m=/([0-9]+)%/.exec(k),n=!!a.horizFirst,p=(e=h!==n)?["width","height"]:["height","width"],r=a.duration/2,u={},q={};d.effects.save(f,g);f.show();c=d.effects.createWrapper(f).css({overflow:"hidden"});e=e?[c.width(),c.height()]:[c.height(),c.width()];m&&(k=parseInt(m[1],10)/100*e[l?0:1]);h&&c.css(n?{height:0,width:k}:{height:k,width:0});u[p[0]]=h?e[0]:k;q[p[1]]=h?e[1]:0;c.animate(u,r,a.easing).animate(q,r,a.easing,function(){l&&
    ...
    d.effects.effect.size=function(a,b){var c,e,f,g,h,l,k=d(this),m="position top bottom left right width height overflow opacity".split(" ");h="position top bottom left right overflow opacity".split(" ");var n=["width","height","overflow"],p=["fontSize"],r=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],u=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],q=d.effects.setMode(k,a.mode||"effect"),t=a.restore||"effect"!==q,v=a.scale||"both",A=a.origin||["middle","center"],
        C=k.css("position"),B=t?m:h,w={height:0,width:0,outerHeight:0,outerWidth:0};"show"===q&&k.show();h={height:k.height(),width:k.width(),outerHeight:k.outerHeight(),outerWidth:k.outerWidth()};"toggle"===a.mode&&"show"===q?(k.from=a.to||w,k.to=a.from||h):(k.from=a.from||("show"===q?w:h),k.to=a.to||("hide"===q?w:h));f=k.from.height/h.height;g=k.from.width/h.width;c=k.to.height/h.height;e=k.to.width/h.width;("box"===v||"both"===v)&&(f!==c&&(B=B.concat(r),k.from=d.effects.setTransition(k,r,f,k.from),k.to=
        d.effects.setTransition(k,r,c,k.to)),g!==e&&(B=B.concat(u),k.from=d.effects.setTransition(k,u,g,k.from),k.to=d.effects.setTransition(k,u,e,k.to)));("content"===v||"both"===v)&&f!==c&&(B=B.concat(p).concat(n),k.from=d.effects.setTransition(k,p,f,k.from),k.to=d.effects.setTransition(k,p,c,k.to));d.effects.save(k,B);k.show();d.effects.createWrapper(k);k.css("overflow","hidden").css(k.from);A&&(l=d.effects.getBaseline(A,h),k.from.top=(h.outerHeight-k.outerHeight())*l.y,k.from.left=(h.outerWidth-k.outerWidth())*
    l.x,k.to.top=(h.outerHeight-k.to.outerHeight)*l.y,k.to.left=(h.outerWidth-k.to.outerWidth)*l.x);k.css(k.from);"content"!==v&&"both"!==v||(r=r.concat(["marginTop","marginBottom"]).concat(p),u=u.concat(["marginLeft","marginRight"]),n=m.concat(r).concat(u),k.find("*[width]").each(function(){var b=d(this),h=b.height(),k=b.width(),l=b.outerHeight(),m=b.outerWidth();t&&d.effects.save(b,n);b.from={height:h*f,width:k*g,outerHeight:l*f,outerWidth:m*g};b.to={height:h*c,width:k*e,outerHeight:h*c,outerWidth:k*
    e};f!==c&&(b.from=d.effects.setTransition(b,r,f,b.from),b.to=d.effects.setTransition(b,r,c,b.to));g!==e&&(b.from=d.effects.setTransition(b,u,g,b.from),b.to=d.effects.setTransition(b,u,e,b.to));b.css(b.from);b.animate(b.to,a.duration,a.easing,function(){t&&d.effects.restore(b,n)})}));k.animate(k.to,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){0===k.to.opacity&&k.css("opacity",k.from.opacity);"hide"===q&&k.hide();d.effects.restore(k,B);t||("static"===C?k.css({position:"relative",
        ...
        m="horizontal"!==h?g/100:1,g="vertical"!==h?g/100:1;e.effect="size";e.queue=!1;e.complete=b;"effect"!==f&&(e.origin=l||["middle","center"],e.restore=!0);e.from=a.from||("show"===f?{height:0,width:0,outerHeight:0,outerWidth:0}:k);e.to={height:k.height*m,width:k.width*g,outerHeight:k.outerHeight*m,outerWidth:k.outerWidth*g};e.fade&&("show"===f&&(e.from.opacity=0,e.to.opacity=1),"hide"===f&&(e.from.opacity=1,e.to.opacity=0));c.effect(e)};d.effects.effect.puff=function(a,b){var c=d(this),e=d.effects.setMode(c,
        a.mode||"hide"),f="hide"===e,g=parseInt(a.percent,10)||150,h=g/100,l={height:c.height(),width:c.width(),outerHeight:c.outerHeight(),outerWidth:c.outerWidth()};d.extend(a,{effect:"scale",queue:!1,fade:!0,mode:e,complete:b,percent:f?g:100,from:f?l:{height:l.height*h,width:l.width*h,outerHeight:l.outerHeight*h,outerWidth:l.outerWidth*h}});c.effect(a)};d.effects.effect.pulsate=function(a,b){var c,e=d(this),f=d.effects.setMode(e,a.mode||"show");c="show"===f;var g="hide"===f,f=2*(a.times||5)+(c||"hide"===
        f?1:0),h=a.duration/f,l=0,k=e.queue(),m=k.length;(c||!e.is(":visible"))&&(e.css("opacity",0).show(),l=1);for(c=1;f>c;c++)e.animate({opacity:l},h,a.easing),l=1-l;e.animate({opacity:l},h,a.easing);e.queue(function(){g&&e.hide();b()});1<m&&k.splice.apply(k,[1,0].concat(k.splice(m,f+1)));e.dequeue()};d.effects.effect.shake=function(a,b){var c,e=d(this),f="position top bottom left right height width".split(" "),g=d.effects.setMode(e,a.mode||"effect"),h=a.direction||"left";c=a.distance||20;var l=a.times||
        3,k=2*l+1,m=Math.round(a.duration/k),n="up"===h||"down"===h?"top":"left",p="up"===h||"left"===h,h={},r={},u={},q=e.queue(),t=q.length;d.effects.save(e,f);e.show();d.effects.createWrapper(e);h[n]=(p?"-=":"+=")+c;r[n]=(p?"+=":"-=")+2*c;u[n]=(p?"-=":"+=")+2*c;e.animate(h,m,a.easing);for(c=1;l>c;c++)e.animate(r,m,a.easing).animate(u,m,a.easing);e.animate(r,m,a.easing).animate(h,m/2,a.easing).queue(function(){"hide"===g&&e.hide();d.effects.restore(e,f);d.effects.removeWrapper(e);b()});1<t&&q.splice.apply(q,
        [1,0].concat(q.splice(t,k+1)));e.dequeue()};d.effects.effect.slide=function(a,b){var c,e=d(this),f="position top bottom left right width height".split(" "),g=d.effects.setMode(e,a.mode||"show"),h="show"===g;c=a.direction||"left";var l="up"===c||"down"===c?"top":"left",k="up"===c||"left"===c,m={};d.effects.save(e,f);e.show();c=a.distance||e["top"===l?"outerHeight":"outerWidth"](!0);d.effects.createWrapper(e).css({overflow:"hidden"});h&&e.css(l,k?isNaN(c)?"-"+c:-c:c);m[l]=(h?k?"+=":"-=":k?"-=":"+=")+
    c;e.animate(m,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===g&&e.hide();d.effects.restore(e,f);d.effects.removeWrapper(e);b()}})};d.effects.effect.transfer=function(a,b){var c=d(this),e=d(a.to),f="fixed"===e.css("position"),g=d("body"),h=f?g.scrollTop():0,g=f?g.scrollLeft():0,l=e.offset(),e={top:l.top-h,left:l.left-g,height:e.innerHeight(),width:e.innerWidth()},l=c.offset(),k=d("<div class='ui-effects-transfer'></div>").appendTo(document.body).addClass(a.className).css({top:l.top-
    h,left:l.left-g,height:c.innerHeight(),width:c.innerWidth(),position:f?"fixed":"absolute"}).animate(e,a.duration,a.easing,function(){k.remove();b()})};d.widget("ui.progressbar",{version:"1.11.0",options:{max:100,value:0,change:null,complete:null},min:0,_create:function(){this.oldValue=this.options.value=this._constrainedValue();this.element.addClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").attr({role:"progressbar","aria-valuemin":this.min});this.valueDiv=d("<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>").appendTo(this.element);
    ...
    a.ctrlKey||(c.$element.removeClass("ui-selected"),c.selected=!1,c.$element.addClass("ui-unselecting"),c.unselecting=!0,b._trigger("unselecting",a,{unselecting:c.element}))}),d(a.target).parents().addBack().each(function(){var c,f=d.data(this,"selectable-item");return f?(c=!a.metaKey&&!a.ctrlKey||!f.$element.hasClass("ui-selected"),f.$element.removeClass(c?"ui-unselecting":"ui-selected").addClass(c?"ui-selecting":"ui-unselecting"),f.unselecting=!c,f.selecting=c,f.selected=c,c?b._trigger("selecting",
        a,{selecting:f.element}):b._trigger("unselecting",a,{unselecting:f.element}),!1):void 0}))},_mouseDrag:function(a){if(this.dragged=!0,!this.options.disabled){var b,c=this,e=this.options,f=this.opos[0],g=this.opos[1],h=a.pageX,l=a.pageY;return f>h&&(b=h,h=f,f=b),g>l&&(b=l,l=g,g=b),this.helper.css({left:f,top:g,width:h-f,height:l-g}),this.selectees.each(function(){var b=d.data(this,"selectable-item"),m=!1;b&&b.element!==c.element[0]&&("touch"===e.tolerance?m=!(b.left>h||f>b.right||b.top>l||g>b.bottom):
    "fit"===e.tolerance&&(m=b.left>f&&h>b.right&&b.top>g&&l>b.bottom),m?(b.selected&&(b.$element.removeClass("ui-selected"),b.selected=!1),b.unselecting&&(b.$element.removeClass("ui-unselecting"),b.unselecting=!1),b.selecting||(b.$element.addClass("ui-selecting"),b.selecting=!0,c._trigger("selecting",a,{selecting:b.element}))):(b.selecting&&((a.metaKey||a.ctrlKey)&&b.startselected?(b.$element.removeClass("ui-selecting"),b.selecting=!1,b.$element.addClass("ui-selected"),b.selected=!0):(b.$element.removeClass("ui-selecting"),
    ...
    this.orientation+" ui-widget ui-widget-content ui-corner-all");this._refresh();this._setOption("disabled",this.options.disabled);this._animateOff=!1},_refresh:function(){this._createRange();this._createHandles();this._setupEvents();this._refreshValue()},_createHandles:function(){var a,b;a=this.options;var c=this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"),e=[];b=a.values&&a.values.length||1;c.length>b&&(c.slice(b).remove(),c=c.slice(0,b));for(a=c.length;b>a;a++)e.push("<span class='ui-slider-handle ui-state-default ui-corner-all' tabindex='0'></span>");
        ...
        this._mouseDestroy()},_mouseCapture:function(a){var b,c,e,f,g,h,l,k,m=this,n=this.options;return n.disabled?!1:(this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()},this.elementOffset=this.element.offset(),b={x:a.pageX,y:a.pageY},c=this._normValueFromMouse(b),e=this._valueMax()-this._valueMin()+1,this.handles.each(function(a){var b=Math.abs(c-m.values(a));(e>b||e===b&&(a===m._lastChangedValue||m.values(a)===n.min))&&(e=b,f=d(this),g=a)}),h=this._start(a,g),!1===h?!1:
        (this._mouseSliding=!0,this._handleIndex=g,f.addClass("ui-state-active").focus(),l=f.offset(),k=!d(a.target).parents().addBack().is(".ui-slider-handle"),this._clickOffset=k?{left:0,top:0}:{left:a.pageX-l.left-f.width()/2,top:a.pageY-l.top-f.height()/2-(parseInt(f.css("borderTopWidth"),10)||0)-(parseInt(f.css("borderBottomWidth"),10)||0)+(parseInt(f.css("marginTop"),10)||0)},this.handles.hasClass("ui-state-hover")||this._slide(a,g,c),this._animateOff=!0,!0))},_mouseStart:function(){return!0},_mouseDrag:function(a){var b=
    ...
    this.orientation);this._refreshValue();break;case "value":this._animateOff=!0;this._refreshValue();this._change(null,0);this._animateOff=!1;break;case "values":this._animateOff=!0;this._refreshValue();for(c=0;e>c;c+=1)this._change(null,c);this._animateOff=!1;break;case "min":case "max":this._animateOff=!0;this._refreshValue();this._animateOff=!1;break;case "range":this._animateOff=!0,this._refresh(),this._animateOff=!1}},_value:function(){return this._trimAlignValue(this.options.value)},_values:function(a){var b,
        ...
        _valueMax:function(){return this.options.max},_refreshValue:function(){var a,b,c,e,f,g=this.options.range,h=this.options,l=this,k=this._animateOff?!1:h.animate,m={};this.options.values&&this.options.values.length?this.handles.each(function(c){b=100*((l.values(c)-l._valueMin())/(l._valueMax()-l._valueMin()));m["horizontal"===l.orientation?"left":"bottom"]=b+"%";d(this).stop(1,1)[k?"animate":"css"](m,h.animate);!0===l.options.range&&("horizontal"===l.orientation?(0===c&&l.range.stop(1,1)[k?"animate":
            "css"]({left:b+"%"},h.animate),1===c&&l.range[k?"animate":"css"]({width:b-a+"%"},{queue:!1,duration:h.animate})):(0===c&&l.range.stop(1,1)[k?"animate":"css"]({bottom:b+"%"},h.animate),1===c&&l.range[k?"animate":"css"]({height:b-a+"%"},{queue:!1,duration:h.animate})));a=b}):(c=this.value(),e=this._valueMin(),f=this._valueMax(),b=f!==e?(c-e)/(f-e)*100:0,m["horizontal"===this.orientation?"left":"bottom"]=b+"%",this.handle.stop(1,1)[k?"animate":"css"](m,h.animate),"min"===g&&"horizontal"===this.orientation&&
        this.range.stop(1,1)[k?"animate":"css"]({width:b+"%"},h.animate),"max"===g&&"horizontal"===this.orientation&&this.range[k?"animate":"css"]({width:100-b+"%"},{queue:!1,duration:h.animate}),"min"===g&&"vertical"===this.orientation&&this.range.stop(1,1)[k?"animate":"css"]({height:b+"%"},h.animate),"max"===g&&"vertical"===this.orientation&&this.range[k?"animate":"css"]({height:100-b+"%"},{queue:!1,duration:h.animate}))},_handleEvents:{keydown:function(a){var b,c,e,f=d(a.target).data("ui-slider-handle-index");
    ...
    b?0:a.length-b-1},_adjustValue:function(a){var b,c,d=this.options;return b=null!==d.min?d.min:0,c=a-b,c=Math.round(c/d.step)*d.step,a=b+c,a=parseFloat(a.toFixed(this._precision())),null!==d.max&&a>d.max?d.max:null!==d.min&&d.min>a?d.min:a},_stop:function(a){this.spinning&&(clearTimeout(this.timer),clearTimeout(this.mousewheelTimer),this.counter=0,this.spinning=!1,this._trigger("stop",a))},_setOption:function(a,b){if("culture"===a||"numberFormat"===a){var c=this._parse(this.element.val());return this.options[a]=
        b,this.element.val(this._format(c)),void 0}"max"!==a&&"min"!==a&&"step"!==a||"string"!=typeof b||(b=this._parse(b));"icons"===a&&(this.buttons.first().find(".ui-icon").removeClass(this.options.icons.up).addClass(b.up),this.buttons.last().find(".ui-icon").removeClass(this.options.icons.down).addClass(b.down));this._super(a,b);"disabled"===a&&(this.widget().toggleClass("ui-state-disabled",!!b),this.element.prop("disabled",!!b),this.buttons.button(b?"disable":"enable"))},_setOptions:D(function(a){this._super(a)}),
        _parse:function(a){return"string"==typeof a&&""!==a&&(a=window.Globalize&&this.options.numberFormat?Globalize.parseFloat(a,10,this.options.culture):+a),""===a||isNaN(a)?null:a},_format:function(a){return""===a?"":window.Globalize&&this.options.numberFormat?Globalize.format(a,this.options.numberFormat,this.options.culture):a},_refresh:function(){this.element.attr({"aria-valuemin":this.options.min,"aria-valuemax":this.options.max,"aria-valuenow":this._parse(this.element.val())})},isValid:function(){var a=
            this.value();return null===a?!1:a===this._adjustValue(a)},_value:function(a,b){var c;""!==a&&(c=this._parse(a),null!==c&&(b||(c=this._adjustValue(c)),a=this._format(c)));this.element.val(a);this._refresh()},_destroy:function(){this.element.removeClass("ui-spinner-input").prop("disabled",!1).removeAttr("autocomplete").removeAttr("role").removeAttr("aria-valuemin").removeAttr("aria-valuemax").removeAttr("aria-valuenow");this.uiSpinner.replaceWith(this.element)},stepUp:D(function(a){this._stepUp(a)}),
        _stepUp:function(a){this._start()&&(this._spin((a||1)*this.options.step),this._stop())},stepDown:D(function(a){this._stepDown(a)}),_stepDown:function(a){this._start()&&(this._spin((a||1)*-this.options.step),this._stop())},pageUp:D(function(a){this._stepUp((a||1)*this.options.page)}),pageDown:D(function(a){this._stepDown((a||1)*this.options.page)}),value:function(a){return arguments.length?(D(this._value).call(this,a),void 0):this._parse(this.element.val())},widget:function(){return this.uiSpinner}});
    ...
    (a=c),a),this.options.disabled);)a=b?a+1:a-1;return a},_focusNextTab:function(a,b){return a=this._findNextTab(a,b),this.tabs.eq(a).focus(),a},_setOption:function(a,b){return"active"===a?(this._activate(b),void 0):"disabled"===a?(this._setupDisabled(b),void 0):(this._super(a,b),"collapsible"===a&&(this.element.toggleClass("ui-tabs-collapsible",b),b||!1!==this.options.active||this._activate(0)),"event"===a&&this._setupEvents(b),"heightStyle"===a&&this._setupHeightStyle(b),void 0)},_sanitizeSelector:function(a){return a?
        ...
        tabIndex:-1});this.panels=d();this.anchors.each(function(b,c){var e,f,g,h=d(c).uniqueId().attr("id"),l=d(c).closest("li"),k=l.attr("aria-controls");a._isLocal(c)?(e=c.hash,g=e.substring(1),f=a.element.find(a._sanitizeSelector(e))):(g=l.attr("aria-controls")||d({}).uniqueId()[0].id,e="#"+g,f=a.element.find(e),f.length||(f=a._createPanel(g),f.insertAfter(a.panels[b-1]||a.tablist)),f.attr("aria-live","polite"));f.length&&(a.panels=a.panels.add(f));k&&l.data("ui-tabs-aria-controls",k);l.attr({"aria-controls":g,
    ...
    a||-1!==d.inArray(c,a)?d(b).addClass("ui-state-disabled").attr("aria-disabled","true"):d(b).removeClass("ui-state-disabled").removeAttr("aria-disabled");this.options.disabled=a},_setupEvents:function(a){var b={};a&&d.each(a.split(" "),function(a,d){b[d]="_eventHandler"});this._off(this.anchors.add(this.tabs).add(this.panels));this._on(!0,this.anchors,{click:function(a){a.preventDefault()}});this._on(this.anchors,b);this._on(this.tabs,{keydown:"_tabKeydown"});this._on(this.panels,{keydown:"_panelKeydown"});
        ...
        a,c)||(b.active=g?!1:this.tabs.index(e),this.active=f?d():e,this.xhr&&this.xhr.abort(),l.length||h.length||d.error("jQuery UI Tabs: Mismatching fragment identifier."),h.length&&this.load(this.tabs.index(e),a),this._toggle(a,c))},_toggle:function(a,b){function c(){f.running=!1;f._trigger("activate",a,b)}function e(){b.newTab.closest("li").addClass("ui-tabs-active ui-state-active");g.length&&f.options.show?f._show(g,f.options.show,c):(g.show(),c())}var f=this,g=b.newPanel,h=b.oldPanel;this.running=
